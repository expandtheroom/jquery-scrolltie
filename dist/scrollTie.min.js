...
module.exports=function(e,t,n){n=n||100;var i=window,o=document.body,c=document.documentElement,l=(Math.max(o.scrollHeight,c.scrollHeight,o.offsetHeight,c.offsetHeight,o.clientHeight,c.clientHeight),i.innerHeight||document.documentElement.clientHeight||document.body.clientHeight),h=t+l,d=e.offsetTop,g=e.clientHeight,m=h+n>=d&&d+g+l+n>h;return m};
...
!function(t){"use strict";var i,e,n=require("./scrollTie"),r=[],s=0;i={destroy:function(){t.each(r,function(t,i){i.destroy(r)})},pause:function(){t.each(r,function(t,i){i.pause()})},restart:function(){t.each(r,function(t,i){i.start()})},refresh:function(){t.each(r,function(t,i){i.refresh()})},init:function(){t.each(r,function(t,i){i.isInitialized||i.init()})}},e={destroy:function(){return this.destroy(r),this.$el},pause:function(){return this.pause(),this.$el},restart:function(){return this.start(),this.$el},refresh:function(){return this.refresh(),this.$el},init:function(){return this.isInitialized||this.init(),this.$el}},t.fn.scrollTie=function(i){if("string"==typeof i||!i){var o=i;return t(this).data().plugin_scrollTie?e[o]?e[o].apply(t(this).data().plugin_scrollTie):t.error(o?"ScrollTie doesn't recognize the method "+o:"ScrollTie needs a string reference to a public method or option configuration object."):t.error("ScrollTie not instantiated on this element")}return this.each(function(){if(i.id="scrollTied"+s++,!t.data(this,"plugin_scrollTie")){var e=new n(this,i);r.push(e),t.data(this,"plugin_scrollTie",e)}})},t.scrollTie=function(){var t=arguments[0],e=arguments.length>=2?[].slice.call(arguments,1):[];return i[t]?i[t].apply(null,e):r}}(jQuery);
